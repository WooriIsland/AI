...
- 임정민
1) CNN 기반의 Face Recoginiton 모델 활용 개별 안면 데이터 저장 및 사진 속 인물 추출
...
2) 스스로 판단하여 대화에 참여하고 인근 축제 및 행사 정보 추천(크롤링)
3) LLamaIndex, ChromaDB를 활용하여 대화 내역을 저장하고 일정을 등록 및 조회
...
- 23-10-15 ~ 23-10-16 : CLIP 모델 리서치 (임정민) 
- 23-10-16 ~ 23-10-17 : 채팅 일정 등록 API 구현 (이승현) 
- 23-10-17 ~ 23-10-18 : CLIP 모델 구현 및 서빙 (임정민) 
...
- 23-11-03 ~ 23-11-06 : LLM 모델 교체 (이승현) 
...
🔹 베타 버전
- 23-11-15 ~ 23-11-26 : 지연 시간 개선, 정확도 개선 (이승현) 
...
- 23-11-20 ~ 23-11-20 : DB 스키마 설계 (이승현)
