...
is_called_chain_examples=[
    ...
    {"question": "{chatbot_name}아 내일 일정 예약해줘 current_time: 2023-01-13 02:24:35.654321 Thursday current_user: 릴파 chatbot_name: {chatbot_name}", "answer": "specify_schedule_information"},
    ...
    {"question": "{chatbot_name}아 재밌는 이야기 해줘 current_time: 2023-06-13 11:31:35.321231 Monday current_user: 비챤 chatbot_name: {chatbot_name}", "answer": "general_conversation"},
