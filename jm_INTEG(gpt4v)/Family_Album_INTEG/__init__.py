...
def create_app():
    ...
    from .views import main_views_integ,face_registration_views_integ,album_registration_views_integ,album_inquiry_views_integ,album_update_views_integ,album_delete_views_integ,album_search_views_integ,album_decoration_inquiry_views_integ
    ...
    app.register_blueprint(album_decoration_inquiry_views_integ.bp)
