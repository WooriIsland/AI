...
### ✔️ 가족 유대감 형성을 위한 라이프로깅 SNS '우리가족섬'
...
### ✔️ GPT-4-Vision/Langchain을 활용한 AI 앨범과 GPT-4-1106-Preview/Langchain을 활용한 AI 챗봇이 결합된 Unity 3D 엔진 기반의 메타버스 라이프로깅 SNS '우리가족섬' 프로젝트입니다.

#### 🔹 사이좋은 가족을 위한 메타버스 라이프로깅 SNS<br><br>
 우리가족섬은 가족 구성원의 위치와 일정을 공유하고 함께한 추억들을 기록하는 메타버스 SNS입니다. 우리의 목표는 일상을 공유하여 가족 간의 유대감 형성을 돕고 가족 간의 소통이 더욱 즐거워지도록 돕는 것입니다.

#### 🔹 가족들의 하루를 얼마나 알고 있나요?<br><br>
...
#### 🔹 더 가까워지는 우리 가족<br><br>
 '우리가족섬'은 메타버스 환경에서의 상호작용 경험을 바탕으로  가족 간의 관계 개선을 일차적인 목적으로 합니다. 함께 가상 공간에서 시간을 보내고 우리 가족만의 아지트를 채워 나가는 경험은 공동체의식 함양과 건강하고 민주적인 가족 문화 형성에 기여합니다
...
[1지난해 ‘1인 가구’ 비율 처음으로 40% 넘어서, 김원진, 2023.08.23](https://m.khan.co.kr/national/national-general/article/202208231228001#c2b)<br>
